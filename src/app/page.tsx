...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-6">
      <p className="text-sm">
        A Brazilian obsessed with internet for a decade. Working as a
        Software Engineer for half that time. I love Typescript, Python, 
        gravity falls, learning languages, playing chess, and solving problems with code.
      </p>
      ...
      <div className="flex justify-center gap-6 max-sm:flex-col-reverse sm:justify-between">
        <div className="flex flex-col justify-center gap-4 max-sm:items-center">
          <div className="group -m-8 flex select-all items-center gap-3 p-8 transition-all">
            ...
            <div className="inline-flex items-center gap-3">
              ...
              <a
                href="mailto:costajoao255@gmail.com"
        ...
        <div className="flex flex-col gap-2">
          <a
            href="/joao-costa-cv.pdf"
            download="joao-costa-CV.pdf"
